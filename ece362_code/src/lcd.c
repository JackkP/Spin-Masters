...
//============================================================================
// lcd.c: Adapted from the lcdwiki.com examples. mostly copied from lab8
//============================================================================
...
#define RESET_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR_11; } while(0) // set TFT reset low
#define DC_NUM 14
#define DC_BIT (1<<DC_NUM)
#define DC_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS_14; } while(0) //set Data/Command signal high (data)
#define DC_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR_14; } while(0) //set Data/Command signal low (command)
